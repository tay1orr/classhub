...
export default function AssignmentPostDetailPage() {
  ...
  useEffect(() => {
    ...
    const foundPost = storedPosts.find((p: any) => p.id.toString() === postId?.toString() && p.board === 'assignment')
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="text-center">
          ...
          <Link href="/1-8/assignment">
            <Button className="mt-4">수행평가로 돌아가기</Button>
          </Link>
        </div>
      </div>
    )
          ...
          <div className="space-y-4">
            <div>
              <div className="flex items-center gap-2 mb-3">
                <Badge className="bg-green-500 text-white">수행평가</Badge>
              ...
              <h1 className="text-2xl font-bold text-green-700">{post.title}</h1>
            </div>
